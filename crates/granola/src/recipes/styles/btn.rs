...
/// The `.btn` rule and stylesheet recipe.
///
/// # Example
///
/// ```rust
...
/// Recipe for the `.btn:active` rule.
#[derive(Default, Debug, Clone, PartialEq)]
...
/// Recipe for the `.btn:focus-visible` rule.
#[derive(Default, Debug, Clone, PartialEq)]
...
/// Recipe for the `.btn-primary` modifier rule.
///
/// # Example
///
/// ```rust
