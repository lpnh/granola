...
impl StylesheetRecipe for Preflight {
    fn statements_recipe(statements: &mut Vec<CssStatement>) {
        statements.push(CssRule::<UniversalReset>::from_recipe().into());
        statements.push(html_host_defaults());
        statements.push(CssRule::<HrReset>::from_recipe().into());
        statements.push(abbr_text_decoration());
        statements.push(CssRule::<AllHeadingsFontReset>::from_recipe().into());
        statements.push(CssRule::<AnchorInherit>::from_recipe().into());
        ...
        statements.push(table_reset());
        statements.push(moz_focusring_outline());
        ...
        statements.push(list_reset());
        statements.push(replaced_element_display());
        statements.push(replaced_element_sizing());
        statements.push(form_controls_reset());
        statements.push(optgroup_font_weight());
        statements.push(optgroup_option_indent());
        statements.push(file_selector_button_spacing());
        statements.push(placeholder_opacity());
        statements.push(placeholder_color_supports());
        statements.push(textarea_resize());
        statements.push(CssRule::<SearchDecorationAppearance>::from_recipe().into());
        statements.push(date_and_time_value());
        statements.push(datetime_edit_display());
        statements.push(datetime_edit_fields_wrapper());
        statements.push(datetime_edit_padding_block());
        statements.push(calendar_picker_indicator());
        statements.push(moz_ui_invalid_box_shadow());
        statements.push(button_appearance());
        statements.push(CssRule::<SpinButtonHeight>::from_recipe().into());
        statements.push(hidden_display());
    }
}
