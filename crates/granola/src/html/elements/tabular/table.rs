...
macro_rules! table {
    ...
    (@cookbook $r:ty $(,)?) => {
        $crate::html::HtmlTable::<$r>::from_cookbook()
    };
    (@cookbook $r:ty ; $content:expr $(,)?) => {
        $crate::html::HtmlTable::<$r>::from_cookbook().content($content)
    };
    (@cookbook $r:ty ; $first:expr $(, $rest:expr)+ $(,)?) => {
        $crate::html::HtmlTable::<$r>::from_cookbook().content($crate::bake![$first $(, $rest)*])
    };
}
