...
macro_rules! code {
    ...
    (@cookbook $r:ty $(,)?) => {
        $crate::html::HtmlCode::<$r>::from_cookbook()
    };
    (@cookbook $r:ty ; $content:expr $(,)?) => {
        $crate::html::HtmlCode::<$r>::from_cookbook().content($content)
    };
    (@cookbook $r:ty ; $first:expr $(, $rest:expr)+ $(,)?) => {
        $crate::html::HtmlCode::<$r>::from_cookbook().content($crate::bake![$first $(, $rest)*])
    };
}
