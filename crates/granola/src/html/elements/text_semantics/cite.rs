...
macro_rules! cite {
    ...
    (@cookbook $r:ty $(,)?) => {
        $crate::html::HtmlCite::<$r>::from_cookbook()
    };
    (@cookbook $r:ty ; $content:expr $(,)?) => {
        $crate::html::HtmlCite::<$r>::from_cookbook().content($content)
    };
    (@cookbook $r:ty ; $first:expr $(, $rest:expr)+ $(,)?) => {
        $crate::html::HtmlCite::<$r>::from_cookbook().content($crate::bake![$first $(, $rest)*])
    };
}
