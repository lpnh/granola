...
#[recipe(name = BdiRecipe, content = Cow<'static, str>)]
...
macro_rules! bdi {
    ...
    (@cookbook $r:ty $(,)?) => {
        $crate::html::HtmlBdi::<$r>::from_cookbook()
    };
    (@cookbook $r:ty ; $content:expr $(,)?) => {
        $crate::html::HtmlBdi::<$r>::from_cookbook().content($content)
    };
    (@cookbook $r:ty ; $first:expr $(, $rest:expr)+ $(,)?) => {
        $crate::html::HtmlBdi::<$r>::from_cookbook().content($crate::bake![$first $(, $rest)*])
    };
}
