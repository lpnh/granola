...
/// use granola::prelude::*;
///
/// let color: HtmlMark = HtmlMark::new("was the color of television, tuned to a dead channel");
///
/// let sky = bake_inline![ "The sky above the port ", color];
///
/// assert_eq!(sky,
/// "The sky above the port <mark>was the color of television, tuned to a dead channel</mark>");
/// ```
///
/// # Askama template
///
