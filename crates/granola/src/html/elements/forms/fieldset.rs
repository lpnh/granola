...
macro_rules! fieldset {
    ...
    (@cookbook $r:ty $(,)?) => {
        $crate::html::HtmlFieldset::<$r>::from_cookbook()
    };
    (@cookbook $r:ty ; $content:expr $(,)?) => {
        $crate::html::HtmlFieldset::<$r>::from_cookbook().content($content)
    };
    (@cookbook $r:ty ; $first:expr $(, $rest:expr)+ $(,)?) => {
        $crate::html::HtmlFieldset::<$r>::from_cookbook().content($crate::bake![$first $(, $rest)*])
    };
}
