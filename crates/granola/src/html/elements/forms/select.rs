...
impl<R: SelectRecipe<Content = Cow<'static, str>>> HtmlSelect<R> {
...
macro_rules! select {
    ...
    (@cookbook $r:ty $(,)?) => {
        $crate::html::HtmlSelect::<$r>::from_cookbook()
    };
    (@cookbook $r:ty ; $content:expr $(,)?) => {
        $crate::html::HtmlSelect::<$r>::from_cookbook().content($content)
    };
    (@cookbook $r:ty ; $first:expr $(, $rest:expr)+ $(,)?) => {
        $crate::html::HtmlSelect::<$r>::from_cookbook().content($crate::bake![$first $(, $rest)*])
    };
}
