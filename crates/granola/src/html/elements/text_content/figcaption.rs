...
macro_rules! figcaption {
    ...
    (@cookbook $r:ty $(,)?) => {
        $crate::html::HtmlFigcaption::<$r>::from_cookbook()
    };
    (@cookbook $r:ty ; $content:expr $(,)?) => {
        $crate::html::HtmlFigcaption::<$r>::from_cookbook().content($content)
    };
    (@cookbook $r:ty ; $first:expr $(, $rest:expr)+ $(,)?) => {
        $crate::html::HtmlFigcaption::<$r>::from_cookbook().content($crate::bake![$first $(, $rest)*])
    };
}
