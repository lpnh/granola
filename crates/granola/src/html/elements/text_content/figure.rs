...
macro_rules! figure {
    ...
    (@cookbook $r:ty $(,)?) => {
        $crate::html::HtmlFigure::<$r>::from_cookbook()
    };
    (@cookbook $r:ty ; $content:expr $(,)?) => {
        $crate::html::HtmlFigure::<$r>::from_cookbook().content($content)
    };
    (@cookbook $r:ty ; $first:expr $(, $rest:expr)+ $(,)?) => {
        $crate::html::HtmlFigure::<$r>::from_cookbook().content($crate::bake![$first $(, $rest)*])
    };
}
