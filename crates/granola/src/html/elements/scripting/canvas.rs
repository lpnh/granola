...
macro_rules! canvas {
    ...
    (@cookbook $r:ty $(,)?) => {
        $crate::html::HtmlCanvas::<$r>::from_cookbook()
    };
    (@cookbook $r:ty ; $content:expr $(,)?) => {
        $crate::html::HtmlCanvas::<$r>::from_cookbook().content($content)
    };
    (@cookbook $r:ty ; $first:expr $(, $rest:expr)+ $(,)?) => {
        $crate::html::HtmlCanvas::<$r>::from_cookbook().content($crate::bake![$first $(, $rest)*])
    };
}
