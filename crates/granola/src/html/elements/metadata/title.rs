...
macro_rules! title {
    ...
    (@cookbook $r:ty $(,)?) => {
        $crate::html::HtmlTitle::<$r>::from_cookbook()
    };
    (@cookbook $r:ty ; $content:expr $(,)?) => {
        $crate::html::HtmlTitle::<$r>::from_cookbook().content($content)
    };
    (@cookbook $r:ty ; $first:expr $(, $rest:expr)+ $(,)?) => {
        $crate::html::HtmlTitle::<$r>::from_cookbook().content($crate::bake![$first $(, $rest)*])
    };
}
