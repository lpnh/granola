...
macro_rules! article {
    ...
    (@cookbook $r:ty $(,)?) => {
        $crate::html::HtmlArticle::<$r>::from_cookbook()
    };
    (@cookbook $r:ty ; $content:expr $(,)?) => {
        $crate::html::HtmlArticle::<$r>::from_cookbook().content($content)
    };
    (@cookbook $r:ty ; $first:expr $(, $rest:expr)+ $(,)?) => {
        $crate::html::HtmlArticle::<$r>::from_cookbook().content($crate::bake![$first $(, $rest)*])
    };
}
