...
macro_rules! footer {
    ...
    (@cookbook $r:ty $(,)?) => {
        $crate::html::HtmlFooter::<$r>::from_cookbook()
    };
    (@cookbook $r:ty ; $content:expr $(,)?) => {
        $crate::html::HtmlFooter::<$r>::from_cookbook().content($content)
    };
    (@cookbook $r:ty ; $first:expr $(, $rest:expr)+ $(,)?) => {
        $crate::html::HtmlFooter::<$r>::from_cookbook().content($crate::bake![$first $(, $rest)*])
    };
}
