...
macro_rules! main {
    ...
    (@cookbook $r:ty $(,)?) => {
        $crate::html::HtmlMain::<$r>::from_cookbook()
    };
    (@cookbook $r:ty ; $content:expr $(,)?) => {
        $crate::html::HtmlMain::<$r>::from_cookbook().content($content)
    };
    (@cookbook $r:ty ; $first:expr $(, $rest:expr)+ $(,)?) => {
        $crate::html::HtmlMain::<$r>::from_cookbook().content($crate::bake![$first $(, $rest)*])
    };
}
