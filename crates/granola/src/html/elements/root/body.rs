...
macro_rules! body {
    ...
    (@cookbook $r:ty $(,)?) => {
        $crate::html::HtmlBody::<$r>::from_cookbook()
    };
    (@cookbook $r:ty ; $content:expr $(,)?) => {
        $crate::html::HtmlBody::<$r>::from_cookbook().content($content)
    };
    (@cookbook $r:ty ; $first:expr $(, $rest:expr)+ $(,)?) => {
        $crate::html::HtmlBody::<$r>::from_cookbook().content($crate::bake![$first $(, $rest)*])
    };
}
