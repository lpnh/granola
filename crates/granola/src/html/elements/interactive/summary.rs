...
macro_rules! summary {
    ...
    (@cookbook $r:ty $(,)?) => {
        $crate::html::HtmlSummary::<$r>::from_cookbook()
    };
    (@cookbook $r:ty ; $content:expr $(,)?) => {
        $crate::html::HtmlSummary::<$r>::from_cookbook().content($content)
    };
    (@cookbook $r:ty ; $first:expr $(, $rest:expr)+ $(,)?) => {
        $crate::html::HtmlSummary::<$r>::from_cookbook().content($crate::bake![$first $(, $rest)*])
    };
}
