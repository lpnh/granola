...
macro_rules! details {
    ...
    (@cookbook $r:ty $(,)?) => {
        $crate::html::HtmlDetails::<$r>::from_cookbook()
    };
    (@cookbook $r:ty ; $content:expr $(,)?) => {
        $crate::html::HtmlDetails::<$r>::from_cookbook().content($content)
    };
    (@cookbook $r:ty ; $first:expr $(, $rest:expr)+ $(,)?) => {
        $crate::html::HtmlDetails::<$r>::from_cookbook().content($crate::bake![$first $(, $rest)*])
    };
}
